				...
				if ($this->form_validation->run() == FALSE) {
					...
					if(count($students)) {
						foreach ($students as $student) {
							...
							$studentSubjectMarks = $studentPositon[$student->srstudentID]['subjectMark'];
							...
							if(count($studenGradeArray)) {
								...
								if(isset($studenGradeArray[$student->srstudentID])) {
									$studenGrades[$student->srroll] = number_format($studenGradeArray[$student->srstudentID] / $totalSubject,2);
								} else {
									$studenGrades[$student->srroll] = number_format(0,2);
								}
							}
						}
					}
