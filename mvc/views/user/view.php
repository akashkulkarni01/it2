    ...
    <section class="panel">
        ...
        <div class="panel-body profile-view-dis">
            ...
            <div class="row">
                ...
                <div class="profile-view-tab">
                        <p><span>PAN Number</span>: <?=$user->pen?></p>
                    </div>

                    <div class="profile-view-tab">
                        <p><span>Aadhar Number</span>: <?=$user->aadhar?></p>
                    </div>

                    <div class="profile-view-tab">
                        <p><span>ESIC Number </span>: <?=$user->esic?></p>
                    </div>

                    <div class="profile-view-tab">
                        <p><span>PF Number </span>: <?=$user->pfno?></p>
                    </div>

                    <div class="profile-view-tab">
                        <p><span>Bank name </span>: <?=$user->bankname?></p>
                    </div>

                    <div class="profile-view-tab">
                        <p><span>Branch Name </span>: <?=$user->branch?></p>
                    </div>

                    <div class="profile-view-tab">
                        <p><span>Account No</span>: <?=$user->accountno?></p>
                    </div>

                    <div class="profile-view-tab">
                        <p><span>IFS Code </span>: <?=$user->ifsc?></p>
                    </div>
