            ...
            <div class="col-sm-10">
                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="cat_title" name="cat_title" value="<?=set_value('cat_title')?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <select id="ot_formula" class="form-control" name="ot_formula">
                                <option value="not">OT Not Applicable</option>
                                <option value="yes">OT Applicable</option>
                            </select>
                            <!-- <input type="text" class="form-control" id="ot_formula" name="ot_formula" value="<?=set_value('ot_formula')?>" > -->
                        </div>
                        <span class="col-sm-12 control-label">
                    ...
                    ?>
                        <label for="min_ot" class="col-sm-4 control-label" style="padding-right: 0px;">
                            <?=$this->lang->line('min_ot')?>
                        </label>
                        <div class="col-sm-5" style="padding-right: 0px;">
                            <input type="text" class="form-control" id="min_ot" name="min_ot" value="<?=set_value('min_ot')?>" >
                        </div>
                        <div class="col-sm-1">
                    ...
                    ?>
                        <label for="max_ot" class="col-sm-5 control-label">
                        <label><input type="checkbox" id="maxot"></label> 
                            <?=$this->lang->line('max_ot')?>
                        </label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="max_ot" name="max_ot" value="<?=set_value('max_ot')?>" >
                        </div>
                        <div class="col-sm-1">
                           <label class="control-label"> Min </label>
                        </div>
                    ...
                    ?>
                        <label for="gracetime_late" class="col-sm-7 control-label">
                            <?=$this->lang->line('gracetime_late')?>
                        </label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="gracetime_late" name="gracetime_late" value="<?=set_value('gracetime_late')?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="gracetime_early" name="gracetime_early" value="<?=set_value('gracetime_early')?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <select id="weekoff1" name="weekoff1" class="form-control dropdown">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <select id="weekoff2" name="weekoff2" class="form-control dropdown">
                                <option value="sunday">Sunday</option>
                                <option value="monday">Monday</option>
                                <option value="tuesday">Tuesday</option>
                                <option value="wednesday">Wednesday</option>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="halfday_calculation" name="halfday_calculation" value="<?=set_value('halfday_calculation')?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="absent_calculation" name="absent_calculation" value="<?=set_value('absent_calculation')?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2" style="margin-left: -75px;">
                            <input type="text" class="form-control" id="partialday_half_calculation" name="partialday_half_calculation" value="<?=set_value('partialday_half_calculation')?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2" style="margin-left: -75px;">
                            <input type="text" class="form-control" id="partialday_absent_calculation" name="partialday_absent_calculation" value="<?=set_value('partialday_absent_calculation')?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="halfday_absent" name="halfday_absent" value="<?=set_value('halfday_absent')?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="halfday_lateby" name="halfday_lateby" value="<?=set_value('halfday_lateby')?>" >
                        </div>
                    ...
                    ?>
                        <label class="col-md-7 control-label">
                            <input type="checkbox" id="halfday_goingbychk"><span style="padding-left: 10px">Mark Absent if late by</span>
                        </label> 

                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="halfday_goingby" name="halfday_goingby" value="<?=set_value('halfday_goingby')?>" >
                        </div>
