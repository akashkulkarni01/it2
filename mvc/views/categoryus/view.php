            ...
            <div class="col-sm-10">
                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <input type="text" disabled class="form-control" id="cat_title" name="cat_title" value="<?=set_value('cat_title', $categoryus->cat_title)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <input type="text" disabled class="form-control" id="short_name" name="short_name" value="<?=set_value('short_name', $categoryus->short_name)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <input type="text" disabled class="form-control" id="ot_formula" name="ot_formula" value="<?=set_value('ot_formula', $categoryus->ot_formula)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" disabled class="form-control" id="min_ot" name="min_ot" value="<?=set_value('min_ot', $categoryus->min_ot)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" disabled class="form-control" id="max_ot" name="max_ot" value="<?=set_value('max_ot', $categoryus->max_ot)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            <input type="text" disabled class="form-control" id="gracetime_late" name="gracetime_late" value="<?=set_value('gracetime_late', $categoryus->gracetime_late)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            <input type="text" disabled class="form-control" id="gracetime_early" name="gracetime_early" value="<?=set_value('gracetime_early', $categoryus->gracetime_early)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" disabled id="weekoff1" name="weekoff1" class="form-control dropdown" value="<?=set_value('weekoff1', $categoryus->weekoff1)?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                        <input type="text" disabled id="weekoff2" name="weekoff2" class="form-control dropdown" value="<?=set_value('weekoff2', $categoryus->weekoff2)?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" disabled class="form-control" id="halfday_calculation" name="halfday_calculation" value="<?=set_value('halfday_calculation', $categoryus->halfday_calculation)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" disabled class="form-control" id="absent_calculation" name="absent_calculation" value="<?=set_value('absent_calculation', $categoryus->absent_calculation)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" disabled class="form-control" id="partialday_half_calculation" name="partialday_half_calculation" value="<?=set_value('partialday_half_calculation', $categoryus->partialday_half_calculation)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" disabled class="form-control" id="partialday_absent_calculation" name="partialday_absent_calculation" value="<?=set_value('partialday_absent_calculation', $categoryus->partialday_absent_calculation)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" disabled class="form-control" id="halfday_absent" name="halfday_absent" value="<?=set_value('halfday_absent', $categoryus->halfday_absent)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" disabled class="form-control" id="halfday_lateby" name="halfday_lateby" value="<?=set_value('halfday_lateby', $categoryus->halfday_lateby)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-2">
                            <input type="text" disabled class="form-control" id="halfday_goingby" name="halfday_goingby" value="<?=set_value('halfday_goingby', $categoryus->halfday_goingby)?>" >
                        </div>
