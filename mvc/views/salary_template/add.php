            ...
            <div class="row">
                <div class="col-sm-12" style="margin-bottom: 10px;">
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" onkeyup="calculateHRADA()" id="basic_salary" name="basic_salary" value="<?=set_value('basic_salary')?>">
                        </div>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-12" id="allowances">
                                    ...
                                    <div class='form-group allowancesfield'>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="allowanceslabel2" name="allowanceslabel2" value="Dearness Allowance" placeholder="<?=$this->lang->line("salary_template_allowances_label")?>">
                                        </div>

                                       

                                        <div class="col-sm-5">
                                            <input type="text" class="form-control allowancesamount" id="allowancesamount2" name="allowancesamount2" value="" placeholder="<?=$this->lang->line("salary_template_allowances_value")?>">
                                        </div>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-12" id="deductions">
                                    ...
                                    <div class='form-group allowancesfield'>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="allowanceslabel2" name="allowanceslabel2" value="Attendance Sort" placeholder="<?=$this->lang->line("attendance_sort_label")?>">
                                        </div>
...
if(basicSalary!=""){
var hra = parseInt(basicSalary)*20/100;
                  
                  if(!isNaN(hra)){
                     $("#allowancesamount1").val(parseInt(hra));
                   }

                  

var da = parseInt(basicSalary)*40/100;

                if(!isNaN(da)){

                  $("#allowancesamount2").val(parseInt(da));
