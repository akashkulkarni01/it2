            ...
            <div class="col-sm-10">
                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="shift_title" name="shift_title" value="<?=set_value('shift_title')?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="brk1_starttime" name="brk1_starttime" value="<?=set_value('brk1_starttime')?>" >
                        </div>
                        <span class="col-sm-12 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="brk1_endtime" name="brk1_endtime" value="<?=set_value('brk1_endtime')?>" >
                        </div>
                        <span class="col-sm-12 control-label">
                   ...
                   <div class='form-group col-md-10' >
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="brk2_starttime" name="brk2_starttime" value="<?=set_value('brk2_starttime')?>" >
                        </div>
                        <span class="col-sm-12 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="brk2_endtime" name="brk2_endtime" value="<?=set_value('brk2_endtime')?>" >
                        </div>
                        <span class="col-sm-12 control-label">
                   ...
                   <div class='form-group col-md-12' >
                        <div class="row" style="margin-left: 0px">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="punch_before" name="punch_before" value="<?=set_value('punch_before')?>">
                            </div>
                            <div class="col-md-6">
                   ...
                   <div class='form-group col-md-12' >
                        <div class="row" style="margin-left: 0px">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="punch_after" name="punch_after" value="<?=set_value('punch_after')?>">
                            </div>
                            <div class="col-md-6">
                   ...
                   <div class='form-group col-md-12' >
                        <div class="row" style="margin-left: 0px">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="grace_time" name="grace_time" value="<?=set_value('grace_time')?>">
                            </div>
                            <div class="col-md-6">
                   ...
                   <div class='form-group col-md-12' >
                        <div class="row" style="margin-left: 0px">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="partial_day" name="partial_day" value="<?=set_value('partial_day')?>">
                            </div>
                            <div class="col-md-2">
                              <input type="text" class="form-control" placeholder="Begin At" id="p_begins" name="p_begins" value="<?=set_value('p_begins')?>">
                            </div>
                            <div class="col-md-2">
                              <input type="text" class="form-control" placeholder="End At" id="p_end" name="p_end" value="<?=set_value('p_end')?>">
                            </div> 
                            <div class="col-md-2">
