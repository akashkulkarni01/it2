...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_productwarehouse')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    <div class="form-group <?=form_error('productwarehousename') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productwarehousename" name="productwarehousename" value="<?=set_value('productwarehousename')?>" >
                        </div>
                    ...
                    <div class="form-group <?=form_error('productwarehousecode') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productwarehousecode" name="productwarehousecode" value="<?=set_value('productwarehousecode')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('productwarehouseemail') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productwarehouseemail" name="productwarehouseemail" value="<?=set_value('productwarehouseemail')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('productwarehousephone') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productwarehousephone" name="productwarehousephone" value="<?=set_value('productwarehousephone')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('productwarehouseaddress') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" style="resize:none;" id="productwarehouseaddress" name="productwarehouseaddress"><?=set_value('productwarehouseaddress')?></textarea>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_productwarehouse")?>" >
                        </div>
                    </div>
                </form>
            </div>
