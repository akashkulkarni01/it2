...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class=""><a data-toggle="tab" href="#featuredImageMediaUpload"><?=$this->lang->line('pages_upload_files')?></a></li>
        <li class="active"><a data-toggle="tab" href="#featuredImageMediaUploadLibrary"><?=$this->lang->line('pages_media_library')?></a></li>
    </ul>
