            ...
            <aside class="page--right--sidebar">
                ...
                <div class="bg-white mb-15">
                    ...
                    <div class="sidebar-body" id="featuredimage-box">
                        ...
                        <span class="featured-image-btn <?=count($send_featured_image) ? 'hide' : ''?>" data-toggle="modal" data-target="#SetFeaturedImage" id="set-featured-img"><?=$this->lang->line('pages_set_featured_image')?></span>
                        <span class="featured-image-btn <?=!count($send_featured_image) ? 'hide' : ''?>" onclick="removeFeatureImage(this, 'featured_image', 'feauret-img-show')"  id="remove-set-featured-img"><?=$this->lang->line('pages_remove_featured_image')?></span>
                    </div>
                </div>
                    ...
                    <div class="sidebar-body sliderImages-box" id="sliderimages-box">
                        <div class="clearfix">
                            <div class="slider-pluck">
                                <?php if(count($send_slider_images)) { foreach ($send_slider_images as $send_slider_image_key => $send_slider_image) {  ?>
