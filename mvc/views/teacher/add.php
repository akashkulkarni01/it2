                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <!-- <?php
                        if(form_error('shift_id'))
                            ...
                            echo "<div class='form-group' >";
                    ?>
                        <label for="shift_id" class="col-sm-2 control-label">
                            <?=$this->lang->line("shift_id")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                $array = [];
                                if(count($shift)) {
                                    foreach ($shift as $shifts) {
                                        $array[$shifts->shift_id] = $shifts->shift_title;
                                    }
                                }
                                echo form_multiselect("shift_id[]", $array, set_value("shift_id", $shift_id), "id='shift_id' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
