            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tbody>
                            <?php if(count($asset_categorys)) {$i = 1; foreach($asset_categorys as $asset_category) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('asset_category')?>">
                                        <?php
                                            if(strlen($asset_category->category) > 25)
                                                echo strip_tags(substr($asset_category->category, 0, 25)."...");
                                            else
                                                echo strip_tags(substr($asset_category->category, 0, 25));
                                        ?>
                                    </td>
