        ...
        <section class="panel">
            ...
            <div class="panel-body profile-view-dis">
                ...
                <div class="row">
                    ...
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("student_studentgroup")?> </span>: <?=isset($studentgroups[$student->studentgroupID]) ? $studentgroups[$student->studentgroupID] : '' ?></p>
                    </div>
                    
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("student_optionalsubject")?> </span>: <?=isset($optionalSubjects[$student->optionalsubjectID]) ? $optionalSubjects[$student->optionalsubjectID] : '' ?></p>
                    </div>
                    ...
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("student_extracurricularactivities")?> </span>: <?=$student->extracurricularactivities?></p>
                    </div>

                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("student_remarks")?> </span>: <?=$student->remarks?></p>
                    </div>
