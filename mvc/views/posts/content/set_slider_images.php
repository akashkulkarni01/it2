<h2><?=$this->lang->line('posts_slider_images')?></h2>
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class=""><a data-toggle="tab" href="#setSliderImagesMediaUpload"><?=$this->lang->line('posts_upload_files')?></a></li>
        <li class="active"><a data-toggle="tab" href="#setSliderImagesMediaUploadLibrary"><?=$this->lang->line('posts_media_library')?></a></li>
    </ul>
    ...
    <div class="tab-content no-padd">
        ...
        <div class="footer--upload">
            <a id="set_slider_images" data-dismiss="modal" onclick="setFileToEditor(this, 'set_slider_images_hidden_field', 'set_slider_images_type');" href="#"><?=$this->lang->line('posts_set_slider_image')?></a>
        </div>
    </div>
</div>