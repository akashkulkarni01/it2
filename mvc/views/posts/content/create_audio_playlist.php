...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class=""><a data-toggle="tab" href="#createAudioPlaylistMediaUpload"><?=$this->lang->line('posts_upload_files')?></a></li>
        <li class="active"><a data-toggle="tab" href="#createAudioPlaylistMediaUploadLibrary"><?=$this->lang->line('posts_media_library')?></a></li>
    </ul>
