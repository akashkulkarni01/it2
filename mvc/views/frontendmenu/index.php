...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div id="edit-menus" class="tab-pane active">
        	<div class="row">
        		<div class="col-sm-12">
	        		<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" <?=!count($fmenus) ? 'style="display: none"' : '' ?>>
        	...
        	<div class="row">
				<div class="col-sm-4">
					<div class="panel-group <?=!count($fmenus) ? 'disable-menu' : '' ?>" id="menu-settings" aria-multiselectable="true">
									...
									<div class="tab-content">
									    <div class="tab-pane active" id="most-recent">
											...
											<div class="menu-settings-footer clearfix">
												...
												<?php } ?>
												<input <?=!count($fmenus) ? 'disabled' : '' ?> type="button" class="submit-btn pull-right pages-add" value="<?=$this->lang->line('frontendmenu_add_to_menu')?>">
											</div>
									    </div>
							      	</div>
							    </div>
									...
									<div class="tab-content">
									    <div class="tab-pane active" id="most-recent">
											...
											<div class="menu-settings-footer clearfix">
												...
												<?php } ?>
												<input <?=!count($fmenus) ? 'disabled' : '' ?> type="button" class="submit-btn pull-right posts-add" value="<?=$this->lang->line('frontendmenu_add_to_menu')?>">
											</div>
									    </div>
							      	</div>
							    </div>
						...
						<div class="panel panel-default">
						    ...
						    <div id="menu-settings-collapse-links" class="panel-collapse collapse" role="tabpanel" aria-labelledby="page-heading-links">
								<div class="panel-body">
									...
									<div class="menu-settings-footer clearfix">
										<input <?=!count($fmenus) ? 'disabled' : '' ?> type="button" class="submit-btn pull-right links-add" value="<?=$this->lang->line('frontendmenu_add_to_menu')?>">
									</div>
								</div>
						    </div>
						</div>
				...
				<div class="col-sm-8">
					<div id="menu-management">
						<div id="create-new-menu-box" <?=count($fmenus) ? 'style="display: none"' : '' ?>>
						...
						<div id="menu-manage-box" <?=!count($fmenus) ? 'style="display: none"' : '' ?>>
							<div class="menu-management-header">
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="publishing-menu-action pull-right">
											<input type="button" <?=!count($fmenus) ? 'disabled' : '' ?> name="save-name" class="save-menu submit-menu" value="<?=$this->lang->line('frontendmenu_save_menu')?>" >
										</div>
									</div>
								</div>
							</div>
							<div id="menu-post-body">
								...
								<div class="menu-settings">
									...
									<fieldset class="menu-settings-list">
									    ...
									    <div class="menu-settings-input">
									        <input <?=count($activefmenu) ? ($activefmenu->topbar == 1) ? ' checked="checked" ' : '' : ''?> type="checkbox"  name="menu-locations_top" id="locations-top" value="1">
									        <label for="locations-top"><?=$this->lang->line('frontendmenu_top_menu')?></label>
									    </div>
									    <div class="menu-settings-input">
									        <input <?=count($activefmenu) ? ($activefmenu->social == 1) ? ' checked="checked" ' : '' : ''?>  type="checkbox" name="menu_locations_social" id="locations-social" value="1">
								...
								<div class="menu-management-footer clearfix">
									...
									<input <?=!count($fmenus) ? 'disabled' : '' ?> type="button"  class="save-menu pull-right submit-menu" value="<?=$this->lang->line('frontendmenu_save_menu')?>">
								</div>
							</div>
						</div>
					</div>
        ...
        <div id="manage-locations" class="tab-pane"> 
        	...
        	<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="<?=base_url('frontendmenu/managelocation')?>">
                ...
                <div>
                	<button <?=!count($fmenus) ? 'disabled' : '' ?> type="submit" class="btn save-menu"><?=$this->lang->line('frontendmenu_save_changes')?></button>
                </div>
            </form>
        </div>
    </div>
